...
export const RECORD_TABLE_OBJECTS: SeedObject[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "coverageCents", label: "Coverage", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign", isReadOnly: true },
      { name: "premiumCents", label: "Premium", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign", isReadOnly: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "value", label: "Value", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign", isReadOnly: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "amountCents", label: "Amount", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "amountRequestedCents", label: "Requested", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign" },
      {
        name: "status",
        label: "Status",
        fieldType: FIELD_TYPES.SELECT,
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "amountAwardedCents", label: "Awarded", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "spendingToDateCents", label: "Spend", fieldType: FIELD_TYPES.CURRENCY, icon: "DollarSign" },
    ],
    defaultView: {
      name: "Grant reports",
      columns: [
