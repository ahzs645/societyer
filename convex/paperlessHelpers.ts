// Paperless helpers extracted from paperless.ts: sync/ingestion/normalization logic. Convex registrations stay in paperless.ts so api.paperless.* paths are unchanged.
