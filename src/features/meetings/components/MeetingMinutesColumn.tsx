          ...
          <div className="card__body">
            {agendaEdit !== null ? (
              ...
              <ol className="meeting-minutes-agenda-list">
                {agenda.map((a, i) => <li key={i}>{formatSourceReferences(a)}</li>)}
              </ol>
            ) : (
          ...
          <>
            ...
            <div className="meeting-minutes-content-grid">
              <div className="meeting-minutes-primary">
                <div className="card">
                  <div className="card__head">
                    <h2 className="card__title">Discussion</h2>
                    <span className="card__subtitle">Narrative record</span>
                  </div>
                  <div className="card__body">
                    ...
                    {sections.length ? (
                      <div className="meeting-minutes-section-list">
                        {sections.map((section: any, index: number) => (
                          <article className="meeting-minutes-section-item" key={`${section.title ?? "section"}-${index}`}>
                            <div className="meeting-minutes-section-item__head">
                              <strong>{index + 1}. {section.title || "Untitled section"}</strong>
                              <div className="row" style={{ gap: 6, flexWrap: "wrap" }}>
                                {section.type && <Badge tone="neutral">{section.type}</Badge>}
                                {section.presenter && <Badge tone="info">{section.presenter}</Badge>}
                                {section.reportSubmitted && <Badge tone="success">Report submitted</Badge>}
                              </div>
                            </div>
                            {section.discussion ? (
