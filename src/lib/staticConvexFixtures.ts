...
const directors = [
  ...
  director("static_director_priya", "Priya", "Sharma", "Vice President", true, true, "2023-06-22"),
  director("static_director_hannah", "Hannah", "Goldberg", "Director", true, true, "2024-06-20"),
  director("static_director_grace", "Grace", "Okafor", "Director", true, true, "2025-06-18"),
];
...
const members = [
  ...
  member("static_member_sam", "Sam", "Nguyen", "Regular", true, "2023-05-02"),
  member("static_member_priya", "Priya", "Sharma", "Regular", true, "2022-03-18"),
  member("static_member_liam", "Liam", "Tremblay", "Regular", true, "2021-09-24"),
  member("static_member_hannah", "Hannah", "Goldberg", "Regular", true, "2020-11-30"),
  member("static_member_wei", "Wei", "Zhang", "Student", true, "2024-09-05"),
  member("static_member_fatima", "Fatima", "Hussain", "Student", true, "2025-01-16"),
  { ...member("static_member_connor", "Connor", "MacDonald", "Regular", true, "2019-06-08"), status: "Inactive", leftAt: "2025-11-30" },
  member("static_member_riley", "Riley", "Chen", "Associate", false, "2024-04-22"),
  member("static_member_grace", "Grace", "Okafor", "Regular", true, "2023-02-11"),
  { ...member("static_member_dario", "Dario", "Rossi", "Regular", false, "2022-07-19"), status: "Inactive", leftAt: "2026-02-01" },
  member("static_member_noor", "Noor", "Ahmadi", "Regular", true, "2021-01-27"),
];
...
const meetings = [
  {
    ...
    quorumSourceLabel: "Bylaw rules v1, effective 2025-06-01",
    ...
    status: "Scheduled",
    minutesId: "static_minutes_board_q2",
  },
  {
    _id: MEETING_AGM_ID,
    societyId: SOCIETY_ID,
...
const filings = [
  ...
  },
  {
    ...
    jurisdictionCode: "CA-BC",
    contextKind: "home",
    periodLabel: "2026 AGM director slate",
    dueDate: "2026-05-01",
    status: "InProgress",
    submissionMethod: "Societies Online",
  },
...
const documents = [
  ...
  {
    _id: "static_document_orghistory_budget_2024",
    societyId: SOCIETY_ID,
    title: "FY2023-2024 approved budget",
    category: "Org History Item",
    content: JSON.stringify({
      ...
      totalIncomeCents: 15200000,
      totalExpenseCents: 14800000,
      netCents: 400000,
      endingBalanceCents: 5840000,
      sourceIds: [],
      lines: [
        { section: "income", label: "Grant revenue", amountCents: 9000000, notes: "Harbour Foundation and City of Vancouver program grants." },
        { section: "income", label: "Membership dues", amountCents: 160000 },
        { section: "income", label: "Program registration fees", amountCents: 1300000 },
        { section: "income", label: "Donations and fundraising", amountCents: 460000 },
        { section: "expense", label: "Wages and benefits", amountCents: 9800000 },
        { section: "expense", label: "Facilities and rent", amountCents: 3400000 },
        { section: "expense", label: "Program supplies", amountCents: 1000000 },
        { section: "expense", label: "Insurance", amountCents: 140000 },
        { section: "expense", label: "Office and admin", amountCents: 460000 },
      ],
    }),
    createdAtISO: "2023-06-15T18:00:00.000Z",
    flaggedForDeletion: false,
    tags: ["org-history", "org-history-item", "budget"],
  },
  {
    _id: "static_document_orghistory_budget_2025",
    societyId: SOCIETY_ID,
    title: "FY2024-2025 approved budget",
    category: "Org History Item",
    content: JSON.stringify({
      kind: "budget",
      title: "FY2024-2025 approved budget",
      ...
      totalIncomeCents: 16800000,
      totalExpenseCents: 16100000,
      netCents: 700000,
      endingBalanceCents: 6540000,
      sourceIds: [],
      lines: [
        { section: "income", label: "Grant revenue", amountCents: 9800000 },
        { section: "income", label: "Membership dues", amountCents: 170000 },
        { section: "income", label: "Program registration fees", amountCents: 1400000 },
        { section: "income", label: "Donations and fundraising", amountCents: 570000, notes: "Includes the fall fundraiser and year-end appeal." },
        { section: "expense", label: "Wages and benefits", amountCents: 10500000 },
        { section: "expense", label: "Facilities and rent", amountCents: 3600000 },
        { section: "expense", label: "Program supplies", amountCents: 1100000 },
        { section: "expense", label: "Insurance", amountCents: 150000 },
        { section: "expense", label: "Office and admin", amountCents: 500000 },
      ],
    }),
    createdAtISO: "2024-06-20T18:00:00.000Z",
    flaggedForDeletion: false,
    tags: ["org-history", "org-history-item", "budget"],
  },
  {
    _id: "static_document_orghistory_budget_2026",
    societyId: SOCIETY_ID,
    title: "FY2025-2026 approved budget",
    category: "Org History Item",
    content: JSON.stringify({
      kind: "budget",
      title: "FY2025-2026 approved budget",
      ...
      totalIncomeCents: 18700000,
      totalExpenseCents: 17650000,
      netCents: 1050000,
      endingBalanceCents: 6240000,
      sourceIds: [],
      lines: [
        { section: "income", label: "Grant revenue", amountCents: 10500000, notes: "Includes the Neighbourhood Youth Resilience grant." },
        { section: "income", label: "Membership dues", amountCents: 180000 },
        { section: "income", label: "Program registration fees", amountCents: 1500000 },
        { section: "income", label: "Donations and fundraising", amountCents: 620000 },
        { section: "expense", label: "Wages and benefits", amountCents: 11200000 },
        { section: "expense", label: "Facilities and rent", amountCents: 3800000 },
        { section: "expense", label: "Program supplies", amountCents: 1150000 },
        { section: "expense", label: "Insurance", amountCents: 150000 },
        { section: "expense", label: "Office and admin", amountCents: 550000 },
        { section: "expense", label: "Advertising", amountCents: 90000 },
        { section: "expense", label: "Utilities", amountCents: 90000 },
      ],
    }),
...
const conflicts = [
  {
    ...
    declaredAt: "2026-03-14",
    contractOrMatter: "Riverside Hall facility rental renewal — Jordan's spouse co-owns the vendor",
    natureOfInterest: "Indirect financial interest through a family member's ownership stake in the vendor",
    meetingId: MEETING_BOARD_ID,
    leftRoom: true,
...
const financials = [
  {
    ...
    presentedAtMeetingId: MEETING_AGM_ID,
    statementsDocId: "static_document_financials",
...
const bylawRules = {
  ...
  version: 1,
  status: "Active",
  effectiveFromISO: "2025-06-01T00:00:00.000Z",
...
const tables: Record<string, any[]> = {
  ...
  roleHolders: [
    ...
    },
    {
      ...
      directorTerm: "2026-03-15",
      startDate: "2026-03-15",
    },
    {
      _id: "static_roleholder_priya",
      societyId: SOCIETY_ID,
      roleType: "director",
      status: "current",
    ...
    },
    {
      ...
      firstName: "Hannah",
      lastName: "Goldberg",
      email: "hannah@riverside.example",
      directorTerm: "2024-06-20",
      startDate: "2024-06-20",
    },
    {
      _id: "static_roleholder_grace",
      societyId: SOCIETY_ID,
      roleType: "director",
      status: "current",
      ...
      directorTerm: "2025-06-18",
      startDate: "2025-06-18",
    },
    {
      _id: "static_roleholder_avery",
      societyId: SOCIETY_ID,
  ...
  insurancePolicies: [
    {
      _id: "static_insurance_do",
      societyId: SOCIETY_ID,
      kind: "DirectorsOfficers",
      insurer: "Northbridge Insurance",
      broker: "Vancouver Nonprofit Insurance Brokers",
      policyNumber: "DO-4471-26",
      coverageCents: 200000000,
      premiumCents: 185000,
      deductibleCents: 250000,
      coverageSummary: "Directors & officers liability for wrongful acts, employment practices, and defence costs.",
    ...
    {
      _id: "static_insurance_gl",
      societyId: SOCIETY_ID,
      kind: "GeneralLiability",
      insurer: "Northbridge Insurance",
      broker: "Vancouver Nonprofit Insurance Brokers",
      policyNumber: "GL-9902-26",
      coverageCents: 500000000,
      premiumCents: 142000,
      deductibleCents: 100000,
      coverageSummary: "Commercial general liability for community hall programs, rentals, and events.",
      startDate: "2025-09-01",
      endDate: "2026-08-31",
      renewalDate: "2026-08-31",
      status: "Active",
  ...
  serviceProviders: [
    {
      _id: "static_provider_bank",
      societyId: SOCIETY_ID,
      function: "banker",
      firmName: "Vancity Credit Union",
      contactName: "Business Banking Services",
      firmLocation: "Vancouver, BC",
      appointedOn: "2017-06-01",
      createdAtISO: "2026-01-05T12:00:00.000Z",
      updatedAtISO: "2026-01-05T12:00:00.000Z",
    },
    {
      _id: "static_provider_accountant",
      societyId: SOCIETY_ID,
      function: "accountant",
      firmName: "Maple Leaf CPA LLP",
      contactName: "Priya Sandhu, CPA",
      firmLocation: "Vancouver, BC",
      appointedOn: "2025-06-19",
      notes: "Engaged for the FY2026 review engagement (appointed at the 2025 AGM).",
      createdAtISO: "2026-01-05T12:00:00.000Z",
      updatedAtISO: "2026-01-05T12:00:00.000Z",
    },
    {
      _id: "static_provider_lawyer",
      societyId: SOCIETY_ID,
      function: "lawyer",
      firmName: "Coastal Nonprofit Law Group",
      contactName: "Renata Osei",
      firmLocation: "Vancouver, BC",
      appointedOn: "2018-03-12",
      createdAtISO: "2026-01-05T12:00:00.000Z",
      updatedAtISO: "2026-01-05T12:00:00.000Z",
    },
  ],
  pipaTrainings: [
    {
      _id: "static_pipa_training_avery",
      societyId: SOCIETY_ID,
      participantName: "Avery Santos",
      role: "Staff",
      participantEmail: "avery@riverside.example",
      topic: "PIPA",
      completedAtISO: "2026-01-15",
      nextDueAtISO: "2027-01-15",
      trainer: "BC FIPA privacy training module",
      notes: "Annual PIPA refresher for the privacy officer.",
    },
    {
      _id: "static_pipa_training_devon",
      societyId: SOCIETY_ID,
      participantName: "Devon Clarke",
      role: "Director",
      topic: "PIPA",
      completedAtISO: "2025-07-10",
      nextDueAtISO: "2026-07-10",
      trainer: "BC FIPA privacy training module",
    },
  ],
  bylawAmendments: [
  ...
  inventoryLocations: [
    {
      _id: "static_inventory_location_hall",
      societyId: SOCIETY_ID,
      name: "Riverside community hall",
      code: "FAC-HALL",
      locationType: "facility",
      address: "2187 Commercial Drive, Vancouver BC",
      active: true,
    ...
    },
    {
      ...
      code: "BIN-FRIDGE",
      locationType: "room",
      parentLocationId: "static_inventory_location_hall",
      active: true,
    ...
    {
      _id: "static_inventory_location_custody_avery",
      societyId: SOCIETY_ID,
      name: "On loan — Avery Santos",
      locationType: "custody",
      custodianName: "Avery Santos",
      active: true,
      notes: "Projector signed out for the fall fundraiser.",
      sourceSystem: "societyer_manual",
      createdAtISO: "2026-05-01T18:00:00.000Z",
      updatedAtISO: "2026-05-01T18:00:00.000Z",
    },
  ...
  receipts: [
    ...
    {
      _id: "static_receipt_yearend_ahmadi",
      societyId: SOCIETY_ID,
      charityNumber: "889912345 RR0001",
      receiptNumber: "RCS-2025-0031",
      donorName: "Ahmadi Family",
      amountCents: 250000,
      eligibleAmountCents: 250000,
      receivedOnISO: "2025-12-22",
      issuedAtISO: "2026-01-08",
      status: "Issued",
      location: "Vancouver, BC",
      isNonCash: false,
    },
