...
const STORAGE_KEY = "societyer.sidebar.operationsDeskHidden";
const CHANGE_EVENT = "societyer:operations-desk-changed";
...
export function useOperationsDeskVisibility() {
