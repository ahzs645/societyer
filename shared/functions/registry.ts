...
export const PORTABLE_FUNCTIONS: PortableFunctionDef[] = [
  ...
  definePortableMutation({ name: "accounting:ensureSocietyerConnection", handler: accountingFns.ensureSocietyerConnectionPortable }),
  definePortableMutation({ name: "accounting:seedSocietyChartOfAccounts", handler: accountingFns.seedSocietyChartOfAccountsPortable }),
  definePortableMutation({ name: "accounting:upsertFiscalPeriod", handler: accountingFns.upsertFiscalPeriodPortable }),
  definePortableMutation({ name: "accounting:closeFiscalPeriod", handler: accountingFns.closeFiscalPeriodPortable }),
  definePortableMutation({ name: "accounting:reopenFiscalPeriod", handler: accountingFns.reopenFiscalPeriodPortable }),
  definePortableMutation({ name: "accounting:upsertCounterparty", handler: accountingFns.upsertCounterpartyPortable }),
  definePortableMutation({ name: "accounting:upsertFundRestriction", handler: accountingFns.upsertFundRestrictionPortable }),
  definePortableMutation({ name: "accounting:upsertAccountMapping", handler: accountingFns.upsertAccountMappingPortable }),
  definePortableMutation({ name: "accounting:upsertJournalEntry", handler: accountingFns.upsertJournalEntryPortable }),
  definePortableMutation({ name: "accounting:postTransactionCandidate", handler: accountingFns.postTransactionCandidatePortable }),
  definePortableMutation({ name: "accounting:postTransactionCandidateAllocation", handler: accountingFns.postTransactionCandidateAllocationPortable }),
  definePortableMutation({ name: "accounting:backfillFinancialTransactionsToJournal", handler: accountingFns.backfillFinancialTransactionsToJournalPortable }),
  definePortableMutation({ name: "accounting:postOpeningBalances", handler: accountingFns.postOpeningBalancesPortable }),
  definePortableMutation({ name: "accounting:createReconciliationRun", handler: accountingFns.createReconciliationRunPortable }),
  definePortableMutation({ name: "accounting:setReconciliationRunStatus", handler: accountingFns.setReconciliationRunStatusPortable }),
  ...
  definePortableMutation({ name: "society:setLogo", handler: societyFns.setLogoPortable }),
  definePortableMutation({ name: "society:clearLogo", handler: societyFns.clearLogoPortable }),
  definePortableMutation({ name: "society:setDarkLogo", handler: societyFns.setDarkLogoPortable }),
  definePortableMutation({ name: "society:clearDarkLogo", handler: societyFns.clearDarkLogoPortable }),
  definePortableMutation({ name: "society:setLetterhead", handler: societyFns.setLetterheadPortable }),
  definePortableMutation({ name: "society:clearLetterhead", handler: societyFns.clearLetterheadPortable }),
