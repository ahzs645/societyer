 ...
 * convex-test oracle.
 *
 * saveSource / saveItem / extractBudgetSourceDetails / bulkImport are also ported
 * here; extractBudgetSourceDetails additionally writes the derived budget
 * snapshot / transaction-candidate / source-evidence rows, all over `ctx.db`.
 */
...
export async function saveSourcePortable(
  ctx: PortableMutationCtx,
...
export async function saveItemPortable(
  ctx: PortableMutationCtx,
...
export async function extractBudgetSourceDetailsPortable(
  ctx: PortableMutationCtx,
...
export async function bulkImportPortable(
  ctx: PortableMutationCtx,
  args: {
    societyId: string;
    sources: any[];
